  ...
  return (
    <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
      <Quote inst="Müller & Co. GmbH" author="Anna Müller">
        Wir waren äußerst zufrieden mit der professionellen Beratung durch RCH Capital Holding GMBH in Erlangen, Deutschland.
      </Quote>
      <Quote inst="Schmidt Finanzdienstleistungen" author="Mario Schmidt">
        Unsere Erwartungen wurden übertroffen - RCH Capital Holding GMBH erwies sich als zuverlässiger und kompetenter Finanzberater.
      </Quote>
      <Quote inst="Wagner Investitionen GmbH" author="Julia Wagner">
        Die Zusammenarbeit mit RCH Capital Holding GMBH war äußerst erfolgreich und wir empfehlen ihre Dienste gerne weiter.
      </Quote>
    </div>
  );
}
